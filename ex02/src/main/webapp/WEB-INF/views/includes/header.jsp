            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/users/users"><i class="fa fa-user fa-fw"></i> USERS</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/member/list"><i class="fa fa-wrench fa-fw"></i> Employees</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> UI Elements<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
